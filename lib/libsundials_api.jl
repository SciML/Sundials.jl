...
function ARKStepResize(arkode_mem, ynew::N_Vector, hscale::realtype, t0::realtype,
...
function ERKStepResize(arkode_mem, ynew::N_Vector, hscale::realtype, t0::realtype,
                       resize::ARKVecResizeFn, resize_data)
...
function MRIStepCreate(fs::ARKRhsFn, t0::realtype, y0::N_Vector, inner_step_id::MRISTEP_ID,
                       inner_step_mem)
...
function MRIStepCreate(fs, t0, y0, inner_step_id, inner_step_mem)
    __y0 = convert(NVector, y0)
    MRIStepCreate(ARKRhsFn_wrapper(fs), t0, convert(N_Vector, __y0), inner_step_id,
                  inner_step_mem)
end

function MRIStepResize(arkode_mem, ynew::N_Vector, t0::realtype, resize::ARKVecResizeFn,
                       resize_data)
...
function CVodeF(cvode_mem, tout, yout, tret, itask, ncheckPtr)
    __yout = convert(NVector, yout)
    CVodeF(cvode_mem, tout, convert(N_Vector, __yout), tret, convert(Cint, itask),
           ncheckPtr)
end
...
function CVodeGetAdjDataPointHermite(cvode_mem, which, t, y, yd)
    ...
    CVodeGetAdjDataPointHermite(cvode_mem, convert(Cint, which), t, convert(N_Vector, __y),
                                convert(N_Vector, __yd))
end
...
function IDAInit(ida_mem, res, t0, yy0, yp0)
    ...
    IDAInit(ida_mem, IDAResFn_wrapper(res), t0, convert(N_Vector, __yy0),
            convert(N_Vector, __yp0))
end
...
function IDASolve(ida_mem, tout::realtype, tret, yret::N_Vector, ypret::N_Vector,
                  itask::Cint)
...
function IDASolve(ida_mem, tout, tret, yret, ypret, itask)
    ...
    IDASolve(ida_mem, tout, tret, convert(N_Vector, __yret), convert(N_Vector, __ypret),
             convert(Cint, itask))
end
...
function IDAInitB(ida_mem, which::Cint, resB::IDAResFnB, tB0::realtype, yyB0::N_Vector,
                  ypB0::N_Vector)
...
function IDAInitB(ida_mem, which, resB, tB0, yyB0, ypB0)
    ...
    IDAInitB(ida_mem, convert(Cint, which), resB, tB0, convert(N_Vector, __yyB0),
             convert(N_Vector, __ypB0))
end

function IDAInitBS(ida_mem, which::Cint, resS::IDAResFnBS, tB0::realtype, yyB0::N_Vector,
                   ypB0::N_Vector)
...
function IDAInitBS(ida_mem, which, resS, tB0, yyB0, ypB0)
    __yyB0 = convert(NVector, yyB0)
    __ypB0 = convert(NVector, ypB0)
    IDAInitBS(ida_mem, convert(Cint, which), resS, tB0, convert(N_Vector, __yyB0),
              convert(N_Vector, __ypB0))
end
...
function IDAReInitB(ida_mem, which, tB0, yyB0, ypB0)
    __yyB0 = convert(NVector, yyB0)
    __ypB0 = convert(NVector, ypB0)
    IDAReInitB(ida_mem, convert(Cint, which), tB0, convert(N_Vector, __yyB0),
               convert(N_Vector, __ypB0))
end
...
function IDACalcICB(ida_mem, which, tout1, yy0, yp0)
    __yy0 = convert(NVector, yy0)
    __yp0 = convert(NVector, yp0)
    IDACalcICB(ida_mem, convert(Cint, which), tout1, convert(N_Vector, __yy0),
               convert(N_Vector, __yp0))
end

function IDACalcICBS(ida_mem, which::Cint, tout1::realtype, yy0::N_Vector, yp0::N_Vector,
                     yyS0, ypS0)
...
function IDACalcICBS(ida_mem, which, tout1, yy0, yp0, yyS0, ypS0)
    __yy0 = convert(NVector, yy0)
    __yp0 = convert(NVector, yp0)
    IDACalcICBS(ida_mem, convert(Cint, which), tout1, convert(N_Vector, __yy0),
                convert(N_Vector, __yp0), yyS0, ypS0)
end

function IDASolveF(ida_mem, tout::realtype, tret, yret::N_Vector, ypret::N_Vector,
...
function IDASolveF(ida_mem, tout, tret, yret, ypret, itask, ncheckPtr)
    __yret = convert(NVector, yret)
    __ypret = convert(NVector, ypret)
    IDASolveF(ida_mem, tout, tret, convert(N_Vector, __yret), convert(N_Vector, __ypret),
...
function IDAGetB(ida_mem, which, tret, yy, yp)
    ...
    __yp = convert(NVector, yp)
    IDAGetB(ida_mem, convert(Cint, which), tret, convert(N_Vector, __yy),
            convert(N_Vector, __yp))
end
...
function IDAGetConsistentICB(ida_mem, which, yyB0, ypB0)
    __yyB0 = convert(NVector, yyB0)
    __ypB0 = convert(NVector, ypB0)
    IDAGetConsistentICB(ida_mem, convert(Cint, which), convert(N_Vector, __yyB0),
                        convert(N_Vector, __ypB0))
end
...
function IDAGetAdjDataPointHermite(ida_mem, which, t, yy, yd)
    __yy = convert(NVector, yy)
    __yd = convert(NVector, yd)
    IDAGetAdjDataPointHermite(ida_mem, convert(Cint, which), t, convert(N_Vector, __yy),
                              convert(N_Vector, __yd))
end
...
function KINSol(kinmem, uu, strategy, u_scale, f_scale)
    ...
    KINSol(kinmem, convert(N_Vector, __uu), convert(Cint, strategy),
           convert(N_Vector, __u_scale), convert(N_Vector, __f_scale))
end
...
function N_VLinearSum_ManyVector(a::realtype, x::N_Vector, b::realtype, y::N_Vector,
                                 z::N_Vector)
...
function N_VLinearSum_ManyVector(a, x, b, y, z)
    ...
    N_VLinearSum_ManyVector(a, convert(N_Vector, __x), b, convert(N_Vector, __y),
...
function N_VProd_ManyVector(x, y, z)
    ...
    __y = convert(NVector, y)
    __z = convert(NVector, z)
    N_VProd_ManyVector(convert(N_Vector, __x), convert(N_Vector, __y),
                       convert(N_Vector, __z))
end
...
function N_VDiv_ManyVector(x, y, z)
    ...
    __y = convert(NVector, y)
    __z = convert(NVector, z)
    N_VDiv_ManyVector(convert(N_Vector, __x), convert(N_Vector, __y),
                      convert(N_Vector, __z))
end
...
function N_VWrmsNormMask_ManyVector(x, w, id)
    ...
    __w = convert(NVector, w)
    __id = convert(NVector, id)
    N_VWrmsNormMask_ManyVector(convert(N_Vector, __x), convert(N_Vector, __w),
...
function N_VWSqrSumMaskLocal_ManyVector(x, w, id)
    ...
    __w = convert(NVector, w)
    __id = convert(NVector, id)
    N_VWSqrSumMaskLocal_ManyVector(convert(N_Vector, __x), convert(N_Vector, __w),
                                   convert(N_Vector, __id))
end
...
function N_VConstrMaskLocal_ManyVector(c, x, m)
    ...
    N_VConstrMaskLocal_ManyVector(convert(N_Vector, __c), convert(N_Vector, __x),
...
function N_VLinearSum_Serial(a::realtype, x::N_Vector, b::realtype, y::N_Vector,
                             z::N_Vector)
...
function N_VLinearSum_Serial(a, x, b, y, z)
    ...
    __y = convert(NVector, y)
    __z = convert(NVector, z)
    N_VLinearSum_Serial(a, convert(N_Vector, __x), b, convert(N_Vector, __y),
                        convert(N_Vector, __z))
end
...
function N_VWrmsNormMask_Serial(x, w, id)
    ...
    __w = convert(NVector, w)
    __id = convert(NVector, id)
    N_VWrmsNormMask_Serial(convert(N_Vector, __x), convert(N_Vector, __w),
                           convert(N_Vector, __id))
end
...
function N_VConstrMask_Serial(c, x, m)
    ...
    __x = convert(NVector, x)
    __m = convert(NVector, m)
    N_VConstrMask_Serial(convert(N_Vector, __c), convert(N_Vector, __x),
                         convert(N_Vector, __m))
end
...
function N_VWrmsNormMaskVectorArray_Serial(nvecs, X, W, id, nrm)
    __id = convert(NVector, id)
    N_VWrmsNormMaskVectorArray_Serial(convert(Cint, nvecs), X, W, convert(N_Vector, __id),
                                      nrm)
end
...
function N_VWSqrSumMaskLocal_Serial(x, w, id)
    ...
    __w = convert(NVector, w)
    __id = convert(NVector, id)
    N_VWSqrSumMaskLocal_Serial(convert(N_Vector, __x), convert(N_Vector, __w),
                               convert(N_Vector, __id))
end
...
function SUNLinSolSolve(S::SUNLinearSolver, A::SUNMatrix, x::N_Vector, b::N_Vector,
                        tol::realtype)
...
function SUNNonlinSolSolve(NLS::SUNNonlinearSolver, y0::N_Vector, y::N_Vector, w::N_Vector,
...
function SUNNonlinSolSolve(NLS, y0, y, w, tol, callLSetup, mem)
    ...
    __y = convert(NVector, y)
    __w = convert(NVector, w)
    SUNNonlinSolSolve(NLS, convert(N_Vector, __y0), convert(N_Vector, __y),
                      convert(N_Vector, __w), tol, convert(Cint, callLSetup), mem)
end
...
function N_VLinearSum(a, x, b, y, z)
    ...
    __y = convert(NVector, y)
    __z = convert(NVector, z)
    N_VLinearSum(a, convert(N_Vector, __x), b, convert(N_Vector, __y),
                 convert(N_Vector, __z))
end
...
function N_VWSqrSumMaskLocal(x, w, id)
    ...
    __w = convert(NVector, w)
    __id = convert(NVector, id)
    N_VWSqrSumMaskLocal(convert(N_Vector, __x), convert(N_Vector, __w),
                        convert(N_Vector, __id))
end
...
function N_VConstrMaskLocal(c, x, m)
    ...
    __x = convert(NVector, x)
    __m = convert(NVector, m)
    N_VConstrMaskLocal(convert(N_Vector, __c), convert(N_Vector, __x),
                       convert(N_Vector, __m))
end
...
function SUNLinSolSolve_Band(S::SUNLinearSolver, A::SUNMatrix, x::N_Vector, b::N_Vector,
                             tol::realtype)
...
function SUNLinSolSolve_Dense(S::SUNLinearSolver, A::SUNMatrix, x::N_Vector, b::N_Vector,
                              tol::realtype)
...
function SUNLinSolSolve_KLU(S::SUNLinearSolver, A::SUNMatrix, x::N_Vector, b::N_Vector,
                            tol::realtype)
...
function SUNLinSolSolve_LapackBand(S::SUNLinearSolver, A::SUNMatrix, x::N_Vector,
                                   b::N_Vector, tol::realtype)
...
function SUNLinSolSolve_LapackDense(S::SUNLinearSolver, A::SUNMatrix, x::N_Vector,
                                    b::N_Vector, tol::realtype)
...
function SUNLinSolSolve_PCG(S::SUNLinearSolver, nul::SUNMatrix, x::N_Vector, b::N_Vector,
                            tol::realtype)
...
function SUNLinSolSolve_SPBCGS(S::SUNLinearSolver, A::SUNMatrix, x::N_Vector, b::N_Vector,
                               tol::realtype)
...
function SUNLinSolSolve_SPFGMR(S::SUNLinearSolver, A::SUNMatrix, x::N_Vector, b::N_Vector,
                               tol::realtype)
...
function SUNLinSolSolve_SPGMR(S::SUNLinearSolver, A::SUNMatrix, x::N_Vector, b::N_Vector,
                              tol::realtype)
...
function SUNLinSolSolve_SPTFQMR(S::SUNLinearSolver, A::SUNMatrix, x::N_Vector, b::N_Vector,
                                tol::realtype)
...
function SUNNonlinSol_FixedPointSens(count, y, m)
    __y = convert(NVector, y)
    SUNNonlinSol_FixedPointSens(convert(Cint, count), convert(N_Vector, __y),
                                convert(Cint, m))
end
...
function SUNNonlinSolSolve_FixedPoint(NLS::SUNNonlinearSolver, y0::N_Vector, y::N_Vector,
                                      w::N_Vector, tol::realtype, callSetup::Cint, mem)
...
function SUNNonlinSolSolve_FixedPoint(NLS, y0, y, w, tol, callSetup, mem)
    ...
    __y = convert(NVector, y)
    __w = convert(NVector, w)
    SUNNonlinSolSolve_FixedPoint(NLS, convert(N_Vector, __y0), convert(N_Vector, __y),
                                 convert(N_Vector, __w), tol, convert(Cint, callSetup), mem)
end
...
function SUNNonlinSolSolve_Newton(NLS::SUNNonlinearSolver, y0::N_Vector, y::N_Vector,
                                  w::N_Vector, tol::realtype, callLSetup::Cint, mem)
...
function SUNNonlinSolSolve_Newton(NLS, y0, y, w, tol, callLSetup, mem)
    ...
    __y = convert(NVector, y)
    __w = convert(NVector, w)
    SUNNonlinSolSolve_Newton(NLS, convert(N_Vector, __y0), convert(N_Vector, __y),
                             convert(N_Vector, __w), tol, convert(Cint, callLSetup), mem)
end
