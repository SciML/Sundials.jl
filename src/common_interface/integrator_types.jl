...
mutable struct ARKODEIntegrator{uType,pType,memType,solType,algType,fType,UFType,JType,oType,toutType,sizeType,tmpType,LStype,Atype,Mtype} <: AbstractSundialsIntegrator{ARKODE}
    u::uType
    p::pType
    t::Float64
    tprev::Float64
