...
function IDASetUserData(ida_mem, user_data)
    ccall((:IDASetUserData, libsundials_idas), Cint, (Ptr{Void}, Any), ida_mem, user_data)
end
...
function __IDASetUserDataB(ida_mem, which::Cint, user_dataB)
    ccall((:IDASetUserDataB, libsundials_idas), Cint, (Ptr{Void}, Cint, Any), ida_mem, which, user_dataB)
end
