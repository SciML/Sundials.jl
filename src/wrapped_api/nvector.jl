...
function N_VGetSubvector_MPIManyVector(v::N_Vector, vec_num::sunindextype)
...
function N_VGetSubvector_MPIManyVector(v, vec_num)
    __v = convert(NVector, v)
    N_VGetSubvector_MPIManyVector(convert(N_Vector, __v), vec_num)
end

function N_VGetSubvectorArrayPointer_MPIManyVector(v::N_Vector, vec_num::sunindextype)
...
function N_VGetSubvectorArrayPointer_MPIManyVector(v, vec_num)
    __v = convert(NVector, v)
    N_VGetSubvectorArrayPointer_MPIManyVector(convert(N_Vector, __v), vec_num)
end

function N_VSetSubvectorArrayPointer_MPIManyVector(v_data, v::N_Vector, vec_num::sunindextype)
...
function N_VSetSubvectorArrayPointer_MPIManyVector(v_data, v, vec_num)
    __v = convert(NVector, v)
    N_VSetSubvectorArrayPointer_MPIManyVector(v_data, convert(N_Vector, __v), vec_num)
end

function N_VGetNumSubvectors_MPIManyVector(v::N_Vector)
...
function N_VGetNumSubvectors_MPIManyVector(v)
    __v = convert(NVector, v)
    N_VGetNumSubvectors_MPIManyVector(convert(N_Vector, __v))
end

function N_VGetVectorID_MPIManyVector(v::N_Vector)
    ccall((:N_VGetVectorID_MPIManyVector, libsundials_nvecserial), N_Vector_ID, (N_Vector,), v)
end

function N_VGetVectorID_MPIManyVector(v)
    __v = convert(NVector, v)
    N_VGetVectorID_MPIManyVector(convert(N_Vector, __v))
end

function N_VCloneEmpty_MPIManyVector(w::N_Vector)
    ccall((:N_VCloneEmpty_MPIManyVector, libsundials_nvecserial), N_Vector, (N_Vector,), w)
end

function N_VCloneEmpty_MPIManyVector(w)
    __w = convert(NVector, w)
    N_VCloneEmpty_MPIManyVector(convert(N_Vector, __w))
end

function N_VClone_MPIManyVector(w::N_Vector)
    ccall((:N_VClone_MPIManyVector, libsundials_nvecserial), N_Vector, (N_Vector,), w)
end

function N_VClone_MPIManyVector(w)
    __w = convert(NVector, w)
    N_VClone_MPIManyVector(convert(N_Vector, __w))
end

function N_VDestroy_MPIManyVector(v::N_Vector)
    ccall((:N_VDestroy_MPIManyVector, libsundials_nvecserial), Cvoid, (N_Vector,), v)
end

function N_VDestroy_MPIManyVector(v)
    __v = convert(NVector, v)
    N_VDestroy_MPIManyVector(convert(N_Vector, __v))
end

function N_VSpace_MPIManyVector(v::N_Vector, lrw, liw)
...
function N_VSpace_MPIManyVector(v, lrw, liw)
    __v = convert(NVector, v)
    N_VSpace_MPIManyVector(v, lrw, liw)
end

function N_VGetCommunicator_MPIManyVector(v::N_Vector)
...
function N_VGetCommunicator_MPIManyVector(v)
    __v = convert(NVector, v)
    N_VGetCommunicator_MPIManyVector(convert(N_Vector, __v))
end

function N_VGetLength_MPIManyVector(v::N_Vector)
    ccall((:N_VGetLength_MPIManyVector, libsundials_nvecserial), sunindextype, (N_Vector,), v)
end

function N_VGetLength_MPIManyVector(v)
    __v = convert(NVector, v)
    N_VGetLength_MPIManyVector(convert(N_Vector, __v))
end

function N_VLinearSum_MPIManyVector(a::realtype, x::N_Vector, b::realtype, y::N_Vector, z::N_Vector)
...
function N_VLinearSum_MPIManyVector(a, x, b, y, z)
    ...
    __y = convert(NVector, y)
    __z = convert(NVector, z)
    N_VLinearSum_MPIManyVector(a, convert(N_Vector, __x), b, convert(N_Vector, __y), convert(N_Vector, __z))
end

function N_VConst_MPIManyVector(c::realtype, z::N_Vector)
    ccall((:N_VConst_MPIManyVector, libsundials_nvecserial), Cvoid, (realtype, N_Vector), c, z)
end

function N_VConst_MPIManyVector(c, z)
    __z = convert(NVector, z)
    N_VConst_MPIManyVector(c, convert(N_Vector, __z))
end

function N_VProd_MPIManyVector(x::N_Vector, y::N_Vector, z::N_Vector)
...
function N_VProd_MPIManyVector(x, y, z)
    ...
    __y = convert(NVector, y)
    __z = convert(NVector, z)
    N_VProd_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __y), convert(N_Vector, __z))
end
...
function N_VDiv_MPIManyVector(x::N_Vector, y::N_Vector, z::N_Vector)
    __x = convert(NVector, x)
    __y = convert(NVector, y)
    __z = convert(NVector, z)
    N_VDiv_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __y), convert(N_Vector, __z))
end

function N_VScale_MPIManyVector(c::realtype, x::N_Vector, z::N_Vector)
...
function N_VScale_MPIManyVector(c, x, z)
    __x = convert(NVector, x)
    __z = convert(NVector, z)
    N_VScale_MPIManyVector(c, convert(N_Vector, __x), convert(N_Vector, __z))
end

function N_VAbs_MPIManyVector(x::N_Vector, z::N_Vector)
...
function N_VAbs_MPIManyVector(x, z)
    __x = convert(NVector, x)
    __z = convert(NVector, z)
    N_VAbs_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __z))
end

function N_VInv_MPIManyVector(x::N_Vector, z::N_Vector)
...
function N_VInv_MPIManyVector(x, z)
    __x = convert(NVector, x)
    __z = convert(NVector, z)
    N_VInv_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __z))
end

function N_VAddConst_MPIManyVector(x::N_Vector, b::realtype, z::N_Vector)
...
function N_VAddConst_MPIManyVector(x, b, z)
    __x = convert(NVector, x)
    __z = convert(NVector, z)
    N_VAddConst_MPIManyVector(convert(N_Vector, __x), b, convert(N_Vector, __z))
end

function N_VDotProd_MPIManyVector(x::N_Vector, y::N_Vector)
...
function N_VDotProd_MPIManyVector(x, y)
    __x = convert(NVector, x)
    __y = convert(NVector, y)
    N_VDotProd_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __y))
end

function N_VMaxNorm_MPIManyVector(x::N_Vector)
    ccall((:N_VMaxNorm_MPIManyVector, libsundials_nvecserial), realtype, (N_Vector,), x)
end

function N_VMaxNorm_MPIManyVector(x)
    __x = convert(NVector, x)
    N_VMaxNorm_MPIManyVector(convert(N_Vector, __x))
end

function N_VWrmsNorm_MPIManyVector(x::N_Vector, w::N_Vector)
...
function N_VWrmsNorm_MPIManyVector(x, w)
    __x = convert(NVector, x)
    __w = convert(NVector, w)
    N_VWrmsNorm_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __w))
end

function N_VWrmsNormMask_MPIManyVector(x::N_Vector, w::N_Vector, id::N_Vector)
...
function N_VWrmsNormMask_MPIManyVector(x, w, id)
    ...
    __w = convert(NVector, w)
    __id = convert(NVector, id)
    N_VWrmsNormMask_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __w), convert(N_Vector, __id))
end

function N_VMin_MPIManyVector(x::N_Vector)
    ccall((:N_VMin_MPIManyVector, libsundials_nvecserial), realtype, (N_Vector,), x)
end

function N_VMin_MPIManyVector(x)
    __x = convert(NVector, x)
    N_VMin_MPIManyVector(convert(N_Vector, __x))
end

function N_VWL2Norm_MPIManyVector(x::N_Vector, w::N_Vector)
...
function N_VWL2Norm_MPIManyVector(x, w)
    __x = convert(NVector, x)
    __w = convert(NVector, w)
    N_VWL2Norm_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __w))
end

function N_VL1Norm_MPIManyVector(x::N_Vector)
    ccall((:N_VL1Norm_MPIManyVector, libsundials_nvecserial), realtype, (N_Vector,), x)
end

function N_VL1Norm_MPIManyVector(x)
    __x = convert(NVector, x)
    N_VL1Norm_MPIManyVector(convert(N_Vector, x)
end

function N_VCompare_MPIManyVector(c::realtype, x::N_Vector, z::N_Vector)
...
function N_VCompare_MPIManyVector(c, x, z)
    __x = convert(NVector, x)
    __z = convert(NVector, z)
    N_VCompare_MPIManyVector(c, convert(N_Vector, __x), convert(N_Vector, __z))
end

function N_VInvTest_MPIManyVector(x::N_Vector, z::N_Vector)
...
function N_VInvTest_MPIManyVector(x, z)
    __x = convert(NVector, x)
    __z = convert(NVector, z)
    N_VInvTest_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __z))
end

function N_VConstrMask_MPIManyVector(c::N_Vector, x::N_Vector, m::N_Vector)
...
function N_VConstrMask_MPIManyVector(c, x, m)
    ...
    __x = convert(NVector, x)
    __m = convert(NVector, m)
    N_VConstrMask_MPIManyVector(convert(N_Vector, __c), convert(N_Vector, __x), convert(N_Vector, __m))
end

function N_VMinQuotient_MPIManyVector(num::N_Vector, denom::N_Vector)
...
function N_VMinQuotient_MPIManyVector(num, denom)
    __num = convert(NVector, num)
    __denom = convert(NVector, denom)
    N_VMinQuotient_MPIManyVector(convert(N_Vector, __num), convert(N_Vector, __denom))
end

function N_VLinearCombination_MPIManyVector(nvec::Cint, c, V, z::N_Vector)
    ccall((:N_VLinearCombination_MPIManyVector, libsundials_nvecserial), Cint, (Cint, Ptr{realtype}, Ptr{N_Vector}, N_Vector), nvec, c, V, z)
end

function N_VLinearCombination_MPIManyVector(nvec::Int, c, V, z)
    __z = convert(NVector, z)
    N_VLinearCombination_MPIManyVector(convert(Cint, nvec), c, V, convert(N_Vector, __z))
end

function N_VScaleAddMulti_MPIManyVector(nvec::Cint, a, x::N_Vector, Y, Z)
...
function N_VScaleAddMulti_MPIManyVector(nvec::Int, a, x, Y, Z)
    __x = convert(NVector, x)
    N_VScaleAddMulti_MPIManyVector(convert(Cint, nvec), a, convert(N_Vector, __x), Y, Z)
end

function N_VDotProdMulti_MPIManyVector(nvec::Cint, x::N_Vector, Y, dotprods)
...
function N_VDotProdMulti_MPIManyVector(nvec::Int, x, Y, dotprods)
    __x = convert(NVector, x)
    N_VDotProdMulti_MPIManyVector(convert(Cint, nvec), convert(N_Vector, __x), Y, dotprods)
end

function N_VLinearSumVectorArray_MPIManyVector(nvec::Cint, a::realtype, X, b::realtype, Y, Z)
...
function N_VLinearSumVectorArray_MPIManyVector(nvec::Int, a, X, b, Y, Z)
    N_VLinearSumVectorArray_MPIManyVector(convert(Cint, nvec), a, X, b, Y, Z)
end

function N_VScaleVectorArray_MPIManyVector(nvec::Cint, c, X, Z)
...
function N_VScaleVectorArray_MPIManyVector(nvec::Int, c, X, Z)
    N_VScaleVectorArray_MPIManyVector(convert(Cint, nvec), c, X, Z)
end

function N_VConstVectorArray_MPIManyVector(nvecs::Cint, c::realtype, Z)
    ccall((:N_VConstVectorArray_MPIManyVector, libsundials_nvecserial), Cint, (Cint, realtype, Ptr{N_Vector}), nvecs, c, Z)
end

function N_VConstVectorArray_MPIManyVector(nvecs::Int, c, Z)
    N_VConstVectorArray_MPIManyVector(convert(Cint, nvecs), c, Z)
end

function N_VWrmsNormVectorArray_MPIManyVector(nvecs::Cint, X, W, nrm)
...
function N_VWrmsNormVectorArray_MPIManyVector(nvecs::Int, X, W, nrm)
    N_VWrmsNormVectorArray_MPIManyVector(convert(Cint, nvecs), X, W, nrm)
end

function N_VWrmsNormMaskVectorArray_MPIManyVector(nvec::Cint, X, W, id, nrm)
...
function N_VWrmsNormMaskVectorArray_MPIManyVector(nvec::Int, X, W, id, nrm)
    N_VWrmsNormMaskVectorArray_MPIManyVector(convert(Cint, nvec), X, W, id, nrm)
end

function N_VDotProdLocal_MPIManyVector(x::N_Vector, y::N_Vector)
...
function N_VDotProdLocal_MPIManyVector(x, y)
    __x = convert(NVector, x)
    __y = convert(NVector, y)
    N_VDotProdLocal_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __y))
end

function N_VMaxNormLocal_MPIManyVector(x::N_Vector)
    ccall((:N_VMaxNormLocal_MPIManyVector, libsundials_nvecserial), realtype, (N_Vector,), x)
end

function N_VMaxNormLocal_MPIManyVector(x)
    __x = convert(NVector, x)
    N_VMaxNormLocal_MPIManyVector(convert(N_Vector, __x))
end

function N_VMinLocal_MPIManyVector(x::N_Vector)
    ccall((:N_VMinLocal_MPIManyVector, libsundials_nvecserial), realtype, (N_Vector,), x)
end

function N_VMinLocal_MPIManyVector(x)
    __x = convert(NVector, x)
    N_VMinLocal_MPIManyVector(convert(N_Vector, __x))
end

function N_VL1NormLocal_MPIManyVector(x::N_Vector)
    ccall((:N_VL1NormLocal_MPIManyVector, libsundials_nvecserial), realtype, (N_Vector,), x)
end

function N_VL1NormLocal_MPIManyVector(x)
    __x = convert(NVector, x)
    N_VL1NormLocal_MPIManyVector(convert(N_Vector, __x))
end

function N_VWSqrSumLocal_MPIManyVector(x::N_Vector, w::N_Vector)
...
function N_VWSqrSumLocal_MPIManyVector(x, w)
    __x = convert(NVector, x)
    __w = convert(NVector, w)
    N_VWSqrSumLocal_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __w))
end

function N_VWSqrSumMaskLocal_MPIManyVector(x::N_Vector, w::N_Vector, id::N_Vector)
...
function N_VWSqrSumMaskLocal_MPIManyVector(x, w, id)
    ...
    __w = convert(NVector, w)
    __id = convert(NVector, id)
    N_VWSqrSumMaskLocal_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __w), convert(N_Vector, __id))
end

function N_VInvTestLocal_MPIManyVector(x::N_Vector, z::N_Vector)
...
function N_VInvTestLocal_MPIManyVector(x, z)
    __x = convert(NVector, x)
    __z = convert(NVector, z)
    N_VInvTestLocal_MPIManyVector(convert(N_Vector, __x), convert(N_Vector, __z))
end

function N_VConstrMaskLocal_MPIManyVector(c::N_Vector, x::N_Vector, m::N_Vector)
...
function N_VConstrMaskLocal_MPIManyVector(c, x, m)
    ...
    __x = convert(NVector, x)
    __m = convert(NVector, m)
    N_VConstrMaskLocal_MPIManyVector(convert(N_Vector, __c), convert(N_Vector, __x), convert(N_Vector, __m))
end

function N_VMinQuotientLocal_MPIManyVector(num::N_Vector, denom::N_Vector)
...
function N_VMinQuotientLocal_MPIManyVector(num, denom)
    __num = convert(NVector, num)
    __denom = convert(NVector, denom)
    N_VMinQuotientLocal_MPIManyVector(convert(N_Vector, __num), convert(N_Vector, __denom))
end

function N_VEnableFusedOps_MPIManyVector(v::N_Vector, tf::Cint)
    ccall((:N_VEnableFusedOps_MPIManyVector, libsundials_nvecserial), Cint, (N_Vector, Cint), v, tf)
end

function N_VEnableFusedOps_MPIManyVector(v, tf::Int)
    __v = convert(NVector, v)
    N_VEnableFusedOps_MPIManyVector(convert(N_Vector, __v), convert(Cint, tf))
end

function N_VEnableLinearCombination_MPIManyVector(v::N_Vector, tf::Cint)
    ccall((:N_VEnableLinearCombination_MPIManyVector, libsundials_nvecserial), Cint, (N_Vector, Cint), v, tf)
end

function N_VEnableLinearCombination_MPIManyVector(v, tf::Int)
    __v = convert(NVector, v)
    N_VEnableLinearCombination_MPIManyVector(convert(N_Vector, __v), convert(Cint, tf))
end

function N_VEnableScaleAddMulti_MPIManyVector(v::N_Vector, tf::Cint)
    ccall((:N_VEnableScaleAddMulti_MPIManyVector, libsundials_nvecserial), Cint, (N_Vector, Cint), v, tf)
end

function N_VEnableScaleAddMulti_MPIManyVector(v, tf::Int)
    __v = convert(NVector, v)
    N_VEnableScaleAddMulti_MPIManyVector(convert(N_Vector, __v), convert(Cint, tf))
end

function N_VEnableDotProdMulti_MPIManyVector(v::N_Vector, tf::Cint)
    ccall((:N_VEnableDotProdMulti_MPIManyVector, libsundials_nvecserial), Cint, (N_Vector, Cint), v, tf)
end

function N_VEnableDotProdMulti_MPIManyVector(v, tf::Int)
    __v = convert(NVector, v)
    N_VEnableDotProdMulti_MPIManyVector(convert(N_Vector, __v), convert(Cint, tf))
end

function N_VEnableLinearSumVectorArray_MPIManyVector(v::N_Vector, tf::Cint)
    ccall((:N_VEnableLinearSumVectorArray_MPIManyVector, libsundials_nvecserial), Cint, (N_Vector, Cint), v, tf)
end

function N_VEnableLinearSumVectorArray_MPIManyVector(v, tf::Int)
    __v = convert(NVector, v)
    N_VEnableLinearSumVectorArray_MPIManyVector(convert(N_Vector, __v), convert(Cint, tf))
end

function N_VEnableScaleVectorArray_MPIManyVector(v::N_Vector, tf::Cint)
    ccall((:N_VEnableScaleVectorArray_MPIManyVector, libsundials_nvecserial), Cint, (N_Vector, Cint), v, tf)
end

function N_VEnableScaleVectorArray_MPIManyVector(v, tf::Int)
    __v = convert(NVector, v)
    N_VEnableScaleVectorArray_MPIManyVector(convert(N_Vector, __v), convert(Cint, tf))
end

function N_VEnableConstVectorArray_MPIManyVector(v::N_Vector, tf::Cint)
    ccall((:N_VEnableConstVectorArray_MPIManyVector, libsundials_nvecserial), Cint, (N_Vector, Cint), v, tf)
end

function N_VEnableConstVectorArray_MPIManyVector(v, tf::Int)
    __v = convert(NVector, v)
    N_VEnableConstVectorArray_MPIManyVector(convert(N_Vector, __v), convert(Cint, tf))
end

function N_VEnableWrmsNormVectorArray_MPIManyVector(v::N_Vector, tf::Cint)
    ccall((:N_VEnableWrmsNormVectorArray_MPIManyVector, libsundials_nvecserial), Cint, (N_Vector, Cint), v, tf)
end

function N_VEnableWrmsNormVectorArray_MPIManyVector(v, tf::Int)
    __v = convert(NVector, v)
    N_VEnableWrmsNormVectorArray_MPIManyVector(convert(N_Vector, __v), convert(Cint, tf))
end

function N_VEnableWrmsNormMaskVectorArray_MPIManyVector(v::N_Vector, tf::Cint)
    ccall((:N_VEnableWrmsNormMaskVectorArray_MPIManyVector, libsundials_nvecserial), Cint, (N_Vector, Cint), v, tf)
end

function N_VEnableWrmsNormMaskVectorArray_MPIManyVector(v, tf::Int)
    __v = convert(NVector, v)
    N_VEnableWrmsNormMaskVectorArray_MPIManyVector(convert(N_Vector, __v), convert(Cint, tf))
end
