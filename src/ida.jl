...
# header: /usr/include/ida/ida_band.h
...
@c Int32 IDABand (Ptr{None},Int32,Int32,Int32) shlib

# header /usr/include/ida/ida_bbdpre.h
@ctypedef IDABBDLocalFn Ptr{Void}
@ctypedef IDABBDCommFn Ptr{Void}
@c Int32 IDABBDPrecInit (Ptr{None},Int32,Int32,Int32,Int32,Int32,realtype,IDABBDLocalFn,IDABBDCommFn) shlib
@c Int32 IDABBDPrecReInit (Ptr{None},Int32,Int32,realtype) shlib
...
# header /usr/include/ida/ida_dense.h
@c Int32 IDADense (Ptr{None},Int32) shlib

# header /usr/include/ida/ida_direct.h
@c Int32 IDADlsGetLastFlag (Ptr{None},Ptr{Int32}) shlib
@c Ptr{Uint8} IDADlsGetReturnFlagName (Int32,) shlib

# header /usr/include/ida/ida.h
...
@c Int32 IDAGetSolution (Ptr{None},realtype,N_Vector,N_Vector) shlib
...
@c Ptr{Uint8} IDAGetReturnFlagName (Int32,) shlib
@c None IDAFree (Ptr{Ptr{None}},) shlib

# header /usr/include/ida/ida_impl.h
...
# header /usr/include/ida/ida_lapack.h
@c Int32 IDALapackDense (Ptr{None},Int32) shlib
@c Int32 IDALapackBand (Ptr{None},Int32,Int32,Int32) shlib

# header /usr/include/ida/ida_spbcgs.h
...
# header /usr/include/ida/ida_spgmr.h
@c Int32 IDASpgmr (Ptr{None},Int32) shlib

# header /usr/include/ida/ida_spils.h
@c Int32 IDASpilsGetLastFlag (Ptr{None},Ptr{Int32}) shlib
@c Ptr{Uint8} IDASpilsGetReturnFlagName (Int32,) shlib

# header /usr/include/ida/ida_sptfqmr.h
