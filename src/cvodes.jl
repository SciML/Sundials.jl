...
# header: /usr/include/cvodes/cvodes_band.h
...
@c Int32 CVBandB (Ptr{None},Int32,Int32,Int32,Int32) shlib

# header /usr/include/cvodes/cvodes_bandpre.h
@c Int32 CVBandPrecInitB (Ptr{None},Int32,Int32,Int32,Int32) shlib

# header /usr/include/cvodes/cvodes_bbdpre.h
@ctypedef CVLocalFnB Ptr{Void}
@ctypedef CVCommFnB Ptr{Void}
@c Int32 CVBBDPrecInitB (Ptr{None},Int32,Int32,Int32,Int32,Int32,Int32,realtype,CVLocalFnB,CVCommFnB) shlib
@c Int32 CVBBDPrecReInitB (Ptr{None},Int32,Int32,Int32,realtype) shlib

# header /usr/include/cvodes/cvodes_dense.h
@c Int32 CVDenseB (Ptr{None},Int32,Int32) shlib

# header /usr/include/cvodes/cvodes_diag.h
@c Int32 CVDiagB (Ptr{None},Int32) shlib

# header /usr/include/cvodes/cvodes_direct.h

# header /usr/include/cvodes/cvodes.h
...
@c Int32 CVodeGetAdjDataPointHermite (Ptr{None},Int64,Ptr{realtype},N_Vector,N_Vector) shlib
@c Int32 CVodeGetAdjDataPointPolynomial (Ptr{None},Int64,Ptr{realtype},Ptr{Int32},N_Vector) shlib
@c Int32 CVodeGetAdjCurrentCheckPoint (Ptr{None},Ptr{Ptr{None}}) shlib

# header /usr/include/cvodes/cvodes_impl.h
...
# header /usr/include/cvodes/cvodes_lapack.h
@c Int32 CVLapackDenseB (Ptr{None},Int32,Int32) shlib
@c Int32 CVLapackBandB (Ptr{None},Int32,Int32,Int32,Int32) shlib

# header /usr/include/cvodes/cvodes_spbcgs.h
...
# header /usr/include/cvodes/cvodes_spgmr.h
@c Int32 CVSpgmrB (Ptr{None},Int32,Int32,Int32) shlib

# header /usr/include/cvodes/cvodes_spils.h

# header /usr/include/cvodes/cvodes_sptfqmr.h
