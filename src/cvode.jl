...
# header: /usr/include/cvode/cvode_band.h
...
@c Int32 CVDlsGetLastFlag (Ptr{None},Ptr{Int32}) shlib
@c Ptr{Uint8} CVDlsGetReturnFlagName (Int32,) shlib
...
@c Int32 CVBand (Ptr{None},Int32,Int32,Int32) shlib

# header /usr/include/cvode/cvode_bandpre.h
@c Int32 CVBandPrecInit (Ptr{None},Int32,Int32,Int32) shlib
...
# header /usr/include/cvode/cvode_bbdpre.h
@ctypedef CVLocalFn Ptr{Void}
@ctypedef CVCommFn Ptr{Void}
@c Int32 CVBBDPrecInit (Ptr{None},Int32,Int32,Int32,Int32,Int32,realtype,CVLocalFn,CVCommFn) shlib
@c Int32 CVBBDPrecReInit (Ptr{None},Int32,Int32,realtype) shlib
@c Int32 CVBBDPrecGetWorkSpace (Ptr{None},Ptr{Int64},Ptr{Int64}) shlib
@c Int32 CVBBDPrecGetNumGfnEvals (Ptr{None},Ptr{Int64}) shlib

# header /usr/include/cvode/cvode_dense.h
...
@c Int32 CVDense (Ptr{None},Int32) shlib

# header /usr/include/cvode/cvode_diag.h
...
@c Int32 CVDiagGetLastFlag (Ptr{None},Ptr{Int32}) shlib
@c Ptr{Uint8} CVDiagGetReturnFlagName (Int32,) shlib

# header /usr/include/cvode/cvode_direct.h

# header /usr/include/cvode/cvode.h
...
@c Ptr{Uint8} CVodeGetReturnFlagName (Int32,) shlib
@c None CVodeFree (Ptr{Ptr{None}},) shlib

# header /usr/include/cvode/cvode_impl.h
...
# header /usr/include/cvode/cvode_lapack.h
@c Int32 CVLapackDense (Ptr{None},Int32) shlib
@c Int32 CVLapackBand (Ptr{None},Int32,Int32,Int32) shlib

# header /usr/include/cvode/cvode_spbcgs.h
...
@c Int32 CVSpilsGetLastFlag (Ptr{None},Ptr{Int32}) shlib
@c Ptr{Uint8} CVSpilsGetReturnFlagName (Int32,) shlib
@c Int32 CVSpbcg (Ptr{None},Int32,Int32) shlib

# header /usr/include/cvode/cvode_spgmr.h
@c Int32 CVSpgmr (Ptr{None},Int32,Int32) shlib

# header /usr/include/cvode/cvode_spils.h

# header /usr/include/cvode/cvode_sptfqmr.h
