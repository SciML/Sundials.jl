...
function SUNNonlinSolInitialize_FixedPoint(NLS::SUNNonlinearSolver)
    ccall(
        (:SUNNonlinSolInitialize_FixedPoint, libsundials_sunnonlinsolfixedpoint),
        Cint,
        (SUNNonlinearSolver,),
        NLS,
    )
...
function SUNNonlinSolSolve_FixedPoint(
    ...
    ccall(
        (:SUNNonlinSolSolve_FixedPoint, libsundials_sunnonlinsolfixedpoint),
        Cint,
...
function SUNNonlinSolFree_FixedPoint(NLS::SUNNonlinearSolver)
    ccall(
        (:SUNNonlinSolFree_FixedPoint, libsundials_sunnonlinsolfixedpoint),
        Cint,
        (SUNNonlinearSolver,),
        NLS,
    )
...
function SUNNonlinSolSetSysFn_FixedPoint(NLS::SUNNonlinearSolver, SysFn::SUNNonlinSolSysFn)
    ccall(
        (:SUNNonlinSolSetSysFn_FixedPoint, libsundials_sunnonlinsolfixedpoint),
        Cint,
...
function SUNNonlinSolSetConvTestFn_FixedPoint(
    ...
    ccall(
        (:SUNNonlinSolSetConvTestFn_FixedPoint, libsundials_sunnonlinsolfixedpoint),
        Cint,
...
function SUNNonlinSolSetMaxIters_FixedPoint(NLS::SUNNonlinearSolver, maxiters::Cint)
    ccall(
        (:SUNNonlinSolSetMaxIters_FixedPoint, libsundials_sunnonlinsolfixedpoint),
        Cint,
...
function SUNNonlinSolSetDamping_FixedPoint(NLS::SUNNonlinearSolver, beta::realtype)
    ccall(
        (:SUNNonlinSolSetDamping_FixedPoint, libsundials_sunnonlinsolfixedpoint),
        Cint,
        (SUNNonlinearSolver, realtype),
        NLS,
        beta,
    )
end
...
function SUNNonlinSolGetNumIters_FixedPoint(NLS::SUNNonlinearSolver, niters)
    ccall(
        (:SUNNonlinSolGetNumIters_FixedPoint, libsundials_sunnonlinsolfixedpoint),
        Cint,
...
function SUNNonlinSolGetCurIter_FixedPoint(NLS::SUNNonlinearSolver, iter)
    ccall(
        (:SUNNonlinSolGetCurIter_FixedPoint, libsundials_sunnonlinsolfixedpoint),
        Cint,
...
function SUNNonlinSolGetSysFn_FixedPoint(NLS::SUNNonlinearSolver, SysFn)
    ccall(
        (:SUNNonlinSolGetSysFn_FixedPoint, libsundials_sunnonlinsolfixedpoint),
        Cint,
...
function SUNNonlinSol_NewtonSens(count::Cint, y::N_Vector)
    ccall(
        (:SUNNonlinSol_NewtonSens, libsundials_sunnonlinsolnewton),
        SUNNonlinearSolver,
        (Cint, N_Vector),
        count,
        y,
...
function SUNNonlinSolInitialize_Newton(NLS::SUNNonlinearSolver)
    ccall(
        (:SUNNonlinSolInitialize_Newton, libsundials_sunnonlinsolnewton),
        Cint,
        (SUNNonlinearSolver,),
        NLS,
    )
...
function SUNNonlinSolSolve_Newton(
    ...
    ccall(
        (:SUNNonlinSolSolve_Newton, libsundials_sunnonlinsolnewton),
        Cint,
        (SUNNonlinearSolver, N_Vector, N_Vector, N_Vector, realtype, Cint, Ptr{Cvoid}),
        NLS,
        y0,
...
function SUNNonlinSolFree_Newton(NLS::SUNNonlinearSolver)
    ccall(
        (:SUNNonlinSolFree_Newton, libsundials_sunnonlinsolnewton),
        Cint,
        (SUNNonlinearSolver,),
        NLS,
    )
...
function SUNNonlinSolSetSysFn_Newton(NLS::SUNNonlinearSolver, SysFn::SUNNonlinSolSysFn)
    ccall(
        (:SUNNonlinSolSetSysFn_Newton, libsundials_sunnonlinsolnewton),
        Cint,
        (SUNNonlinearSolver, SUNNonlinSolSysFn),
        NLS,
        SysFn,
...
function SUNNonlinSolSetLSetupFn_Newton(
    ...
    ccall(
        (:SUNNonlinSolSetLSetupFn_Newton, libsundials_sunnonlinsolnewton),
        Cint,
...
function SUNNonlinSolSetLSolveFn_Newton(
    ...
    ccall(
        (:SUNNonlinSolSetLSolveFn_Newton, libsundials_sunnonlinsolnewton),
        Cint,
...
function SUNNonlinSolSetConvTestFn_Newton(
    ...
    ccall(
        (:SUNNonlinSolSetConvTestFn_Newton, libsundials_sunnonlinsolnewton),
        Cint,
        (SUNNonlinearSolver, SUNNonlinSolConvTestFn, Ptr{Cvoid}),
        NLS,
        CTestFn,
...
function SUNNonlinSolSetMaxIters_Newton(NLS::SUNNonlinearSolver, maxiters::Cint)
    ccall(
        (:SUNNonlinSolSetMaxIters_Newton, libsundials_sunnonlinsolnewton),
        Cint,
        (SUNNonlinearSolver, Cint),
        NLS,
        maxiters,
...
function SUNNonlinSolGetNumIters_Newton(NLS::SUNNonlinearSolver, niters)
    ccall(
        (:SUNNonlinSolGetNumIters_Newton, libsundials_sunnonlinsolnewton),
        Cint,
        (SUNNonlinearSolver, Ptr{Clong}),
        NLS,
        niters,
...
function SUNNonlinSolGetCurIter_Newton(NLS::SUNNonlinearSolver, iter)
    ccall(
        (:SUNNonlinSolGetCurIter_Newton, libsundials_sunnonlinsolnewton),
        Cint,
        (SUNNonlinearSolver, Ptr{Cint}),
        NLS,
        iter,
...
function SUNNonlinSolGetNumConvFails_Newton(NLS::SUNNonlinearSolver, nconvfails)
    ccall(
        (:SUNNonlinSolGetNumConvFails_Newton, libsundials_sunnonlinsolnewton),
        Cint,
        (SUNNonlinearSolver, Ptr{Clong}),
        NLS,
        nconvfails,
...
function SUNNonlinSolGetSysFn_Newton(NLS::SUNNonlinearSolver, SysFn)
    ccall(
        (:SUNNonlinSolGetSysFn_Newton, libsundials_sunnonlinsolnewton),
        Cint,
        (SUNNonlinearSolver, Ptr{SUNNonlinSolSysFn}),
        NLS,
        SysFn,
