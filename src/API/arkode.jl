...
function ARKStepCreate(fe::ARKRhsFn, fi::ARKRhsFn, t0::realtype, y0::N_Vector)
    ccall(
        (:ARKStepCreate, libsundials_arkode),
        ARKStepMemPtr,
        (ARKRhsFn, ARKRhsFn, realtype, N_Vector),
        fe,
        fi,
        t0,
        y0,
...
function ARKStepResize(
    ...
    ccall(
        (:ARKStepResize, libsundials_arkode),
        Cint,
...
function ARKStepReInit(arkode_mem, fe::ARKRhsFn, fi::ARKRhsFn, t0::realtype, y0::N_Vector)
    ccall(
        (:ARKStepReInit, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKRhsFn, ARKRhsFn, realtype, N_Vector),
        arkode_mem,
        fe,
        fi,
        t0,
...
function ARKStepSStolerances(arkode_mem, reltol::realtype, abstol::realtype)
    ccall(
        (:ARKStepSStolerances, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype, realtype),
        arkode_mem,
        reltol,
        abstol,
    )
...
function ARKStepSVtolerances(arkode_mem, reltol::realtype, abstol::N_Vector)
    ccall(
        (:ARKStepSVtolerances, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype, N_Vector),
        arkode_mem,
        reltol,
        abstol,
    )
...
function ARKStepWFtolerances(arkode_mem, efun::ARKEwtFn)
    ccall(
        (:ARKStepWFtolerances, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKEwtFn),
        arkode_mem,
        efun,
    )
end
...
function ARKStepResStolerance(arkode_mem, rabstol::realtype)
    ccall(
        (:ARKStepResStolerance, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        rabstol,
    )
end
...
function ARKStepResFtolerance(arkode_mem, rfun::ARKRwtFn)
    ccall(
        (:ARKStepResFtolerance, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKRwtFn),
        arkode_mem,
        rfun,
    )
end
...
function ARKStepSetLinearSolver(arkode_mem, LS::SUNLinearSolver, A::SUNMatrix)
    ccall(
        (:ARKStepSetLinearSolver, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, SUNLinearSolver, SUNMatrix),
        arkode_mem,
        LS,
        A,
    )
...
function ARKStepSetMassLinearSolver(
    ...
    ccall(
        (:ARKStepSetMassLinearSolver, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, SUNLinearSolver, SUNMatrix, Cint),
        arkode_mem,
        LS,
        M,
        time_dep,
...
function ARKStepSetMassLinearSolver(arkode_mem, LS::SUNLinearSolver, M::SUNMatrix, time_dep)
    ARKStepSetMassLinearSolver(
        ...
        LS::SUNLinearSolver,
        M::SUNMatrix,
        convert(Cint, time_dep),
    )
end

function ARKStepRootInit(arkode_mem, nrtfn::Cint, g::ARKRootFn)
    ccall(
        (:ARKStepRootInit, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint, ARKRootFn),
        arkode_mem,
        nrtfn,
        g,
    )
...
function ARKStepSetOptimalParams(arkode_mem)
    ccall(
        (:ARKStepSetOptimalParams, libsundials_arkode),
        Cint,
        (ARKStepMemPtr,),
        arkode_mem,
    )
...
function ARKStepSetOrder(arkode_mem, maxord::Cint)
    ccall(
        (:ARKStepSetOrder, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        maxord,
...
function ARKStepSetInterpolantType(arkode_mem, itype::Cint)
    ccall(
        (:ARKStepSetInterpolantType, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        itype,
...
function ARKStepSetInterpolantDegree(arkode_mem, degree::Cint)
    ccall(
        (:ARKStepSetInterpolantDegree, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        degree,
...
function ARKStepSetDenseOrder(arkode_mem, dord::Cint)
    ccall(
        (:ARKStepSetDenseOrder, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        dord,
...
function ARKStepSetNonlinearSolver(arkode_mem, NLS::SUNNonlinearSolver)
    ccall(
        (:ARKStepSetNonlinearSolver, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, SUNNonlinearSolver),
        arkode_mem,
        NLS,
    )
end
...
function ARKStepSetLinear(arkode_mem, timedepend::Cint)
    ccall(
        (:ARKStepSetLinear, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        timedepend,
...
function ARKStepSetTables(arkode_mem, q::Cint, p::Cint, Bi, Be)
    ccall(
        (:ARKStepSetTables, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint, Cint, ARKodeButcherTable, ARKodeButcherTable),
        arkode_mem,
        q,
        p,
        Bi,
...
function ARKStepSetTableNum(arkode_mem, itable::Cint, etable::Cint)
    ccall(
        (:ARKStepSetTableNum, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint, Cint),
        arkode_mem,
        itable,
        etable,
    )
...
function ARKStepSetCFLFraction(arkode_mem, cfl_frac::realtype)
    ccall(
        (:ARKStepSetCFLFraction, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        cfl_frac,
...
function ARKStepSetSafetyFactor(arkode_mem, safety::realtype)
    ccall(
        (:ARKStepSetSafetyFactor, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        safety,
...
function ARKStepSetErrorBias(arkode_mem, bias::realtype)
    ccall(
        (:ARKStepSetErrorBias, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        bias,
...
function ARKStepSetMaxGrowth(arkode_mem, mx_growth::realtype)
    ccall(
        (:ARKStepSetMaxGrowth, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        mx_growth,
...
function ARKStepSetFixedStepBounds(arkode_mem, lb::realtype, ub::realtype)
    ccall(
        (:ARKStepSetFixedStepBounds, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype, realtype),
        arkode_mem,
        lb,
...
function ARKStepSetAdaptivityMethod(
    ...
    ccall(
        (:ARKStepSetAdaptivityMethod, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint, Cint, Cint, Ptr{realtype}),
        arkode_mem,
        imethod,
        idefault,
        pq,
...
function ARKStepSetAdaptivityMethod(arkode_mem, imethod, idefault, pq, adapt_params)
    ARKStepSetAdaptivityMethod(
        arkode_mem,
        convert(Cint, imethod),
        convert(Cint, idefault),
        convert(Cint, pq),
        adapt_params,
    )
end
...
function ARKStepSetAdaptivityFn(arkode_mem, hfun::ARKAdaptFn, h_data)
    ccall(
        (:ARKStepSetAdaptivityFn, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKAdaptFn, Ptr{Cvoid}),
        arkode_mem,
        hfun,
        h_data,
    )
...
function ARKStepSetMaxFirstGrowth(arkode_mem, etamx1::realtype)
    ccall(
        (:ARKStepSetMaxFirstGrowth, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        etamx1,
...
function ARKStepSetMaxEFailGrowth(arkode_mem, etamxf::realtype)
    ccall(
        (:ARKStepSetMaxEFailGrowth, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        etamxf,
...
function ARKStepSetSmallNumEFails(arkode_mem, small_nef::Cint)
    ccall(
        (:ARKStepSetSmallNumEFails, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        small_nef,
...
function ARKStepSetMaxCFailGrowth(arkode_mem, etacf::realtype)
    ccall(
        (:ARKStepSetMaxCFailGrowth, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        etacf,
...
function ARKStepSetNonlinCRDown(arkode_mem, crdown::realtype)
    ccall(
        (:ARKStepSetNonlinCRDown, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        crdown,
...
function ARKStepSetNonlinRDiv(arkode_mem, rdiv::realtype)
    ccall(
        (:ARKStepSetNonlinRDiv, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        rdiv,
...
function ARKStepSetDeltaGammaMax(arkode_mem, dgmax::realtype)
    ccall(
        (:ARKStepSetDeltaGammaMax, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        dgmax,
...
function ARKStepSetMaxStepsBetweenLSet(arkode_mem, msbp::Cint)
    ccall(
        (:ARKStepSetMaxStepsBetweenLSet, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        msbp,
...
function ARKStepSetPredictorMethod(arkode_mem, method::Cint)
    ccall(
        (:ARKStepSetPredictorMethod, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        method,
...
function ARKStepSetStabilityFn(arkode_mem, EStab::ARKExpStabFn, estab_data)
    ccall(
        (:ARKStepSetStabilityFn, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKExpStabFn, Ptr{Cvoid}),
        arkode_mem,
        EStab,
        estab_data,
    )
...
function ARKStepSetMaxErrTestFails(arkode_mem, maxnef::Cint)
    ccall(
        (:ARKStepSetMaxErrTestFails, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        maxnef,
...
function ARKStepSetMaxNonlinIters(arkode_mem, maxcor::Cint)
    ccall(
        (:ARKStepSetMaxNonlinIters, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        maxcor,
...
function ARKStepSetMaxConvFails(arkode_mem, maxncf::Cint)
    ccall(
        (:ARKStepSetMaxConvFails, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        maxncf,
...
function ARKStepSetNonlinConvCoef(arkode_mem, nlscoef::realtype)
    ccall(
        (:ARKStepSetNonlinConvCoef, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        nlscoef,
...
function ARKStepSetConstraints(arkode_mem, constraints::N_Vector)
    ccall(
        (:ARKStepSetConstraints, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, N_Vector),
        arkode_mem,
        constraints,
...
function ARKStepSetMaxNumSteps(arkode_mem, mxsteps::Clong)
    ccall(
        (:ARKStepSetMaxNumSteps, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Clong),
        arkode_mem,
        mxsteps,
...
function ARKStepSetMaxHnilWarns(arkode_mem, mxhnil::Cint)
    ccall(
        (:ARKStepSetMaxHnilWarns, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        mxhnil,
...
function ARKStepSetInitStep(arkode_mem, hin::realtype)
    ccall(
        (:ARKStepSetInitStep, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        hin,
...
function ARKStepSetMinStep(arkode_mem, hmin::realtype)
    ccall(
        (:ARKStepSetMinStep, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        hmin,
...
function ARKStepSetMaxStep(arkode_mem, hmax::realtype)
    ccall(
        (:ARKStepSetMaxStep, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        hmax,
...
function ARKStepSetStopTime(arkode_mem, tstop::realtype)
    ccall(
        (:ARKStepSetStopTime, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        tstop,
...
function ARKStepSetFixedStep(arkode_mem, hfixed::realtype)
    ccall(
        (:ARKStepSetFixedStep, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        hfixed,
...
function ARKStepSetMaxNumConstrFails(arkode_mem, maxfails::Cint)
    ccall(
        (:ARKStepSetMaxNumConstrFails, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Cint),
        arkode_mem,
        maxfails,
...
function ARKStepSetRootDirection(arkode_mem, rootdir)
    ccall(
        (:ARKStepSetRootDirection, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Cint}),
        arkode_mem,
        rootdir,
    )
end
...
function ARKStepSetNoInactiveRootWarn(arkode_mem)
    ccall(
        (:ARKStepSetNoInactiveRootWarn, libsundials_arkode),
        Cint,
        (ARKStepMemPtr,),
        arkode_mem,
    )
...
function ARKStepSetErrHandlerFn(arkode_mem, ehfun::ARKErrHandlerFn, eh_data)
    ccall(
        (:ARKStepSetErrHandlerFn, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKErrHandlerFn, Ptr{Cvoid}),
        arkode_mem,
        ehfun,
        eh_data,
    )
...
function ARKStepSetErrFile(arkode_mem, errfp)
    ccall(
        (:ARKStepSetErrFile, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{FILE}),
        arkode_mem,
        errfp,
    )
end
...
function ARKStepSetUserData(arkode_mem, user_data)
    ccall(
        (:ARKStepSetUserData, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Any),
        arkode_mem,
        user_data,
...
function ARKStepSetDiagnostics(arkode_mem, diagfp)
    ccall(
        (:ARKStepSetDiagnostics, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{FILE}),
        arkode_mem,
        diagfp,
...
#This should change to ARKPostProcessFn
function ARKStepSetPostprocessStepFn(arkode_mem, ProcessStep::ARKPostProcessStepFn)
    ccall(
        (:ARKStepSetPostprocessStepFn, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKPostProcessStepFn),
        arkode_mem,
        ProcessStep,
    )
end
...
function ARKStepSetStagePredictFn(arkode_mem, PredictStage::ARKStepStagePredictFn)
    ccall(
        (:ARKStepSetStagePredictFn, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKStepStagePredictFn),
        arkode_mem,
        PredictStage,
    )
end
...
function ARKStepSetJacFn(arkode_mem, jac::ARKLsJacFn)
    ccall(
        (:ARKStepSetJacFn, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKLsJacFn),
        arkode_mem,
        jac,
    )
end
...
function ARKStepSetMassFn(arkode_mem, mass::ARKLsMassFn)
    ccall(
        (:ARKStepSetMassFn, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKLsMassFn),
        arkode_mem,
        mass,
    )
end
...
function ARKStepSetMaxStepsBetweenJac(arkode_mem, msbj::Clong)
    ccall(
        (:ARKStepSetMaxStepsBetweenJac, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Clong),
        arkode_mem,
        msbj,
...
function ARKStepSetEpsLin(arkode_mem, eplifac::realtype)
    ccall(
        (:ARKStepSetEpsLin, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        eplifac,
...
function ARKStepSetMassEpsLin(arkode_mem, eplifac::realtype)
    ccall(
        (:ARKStepSetMassEpsLin, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype),
        arkode_mem,
        eplifac,
...
function ARKStepSetPreconditioner(
    arkode_mem,
    psetup::ARKLsPrecSetupFn,
    psolve::ARKLsPrecSolveFn,
)
    ccall(
        (:ARKStepSetPreconditioner, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKLsPrecSetupFn, ARKLsPrecSolveFn),
        arkode_mem,
        psetup,
        psolve,
    )
...
function ARKStepSetMassPreconditioner(
    arkode_mem,
    psetup::ARKLsMassPrecSetupFn,
    psolve::ARKLsMassPrecSolveFn,
)
    ccall(
        (:ARKStepSetMassPreconditioner, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKLsMassPrecSetupFn, ARKLsMassPrecSolveFn),
        arkode_mem,
        psetup,
        psolve,
    )
...
function ARKStepSetJacTimes(
    arkode_mem,
    jtsetup::ARKLsJacTimesSetupFn,
    jtimes::ARKLsJacTimesVecFn,
)
    ccall(
        (:ARKStepSetJacTimes, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKLsJacTimesSetupFn, ARKLsJacTimesVecFn),
        arkode_mem,
        jtsetup,
        jtimes,
    )
...
function ARKStepSetMassTimes(
    arkode_mem,
    msetup::ARKLsMassTimesSetupFn,
    mtimes::ARKLsMassTimesVecFn,
    mtimes_data,
)
    ccall(
        (:ARKStepSetMassTimes, libsundials_arkode),
        Cint,
...
function ARKStepSetLinSysFn(arkode_mem, linsys::ARKLsLinSysFn)
    ccall(
        (:ARKStepSetLinSysFn, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, ARKLsLinSysFn),
        arkode_mem,
        linsys,
    )
end
...
function ARKStepEvolve(arkode_mem, tout::realtype, yout::N_Vector, tret, itask::Cint)
    ccall(
        (:ARKStepEvolve, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype, N_Vector, Ptr{realtype}, Cint),
        arkode_mem,
        tout,
        yout,
        tret,
...
function ARKStepGetDky(arkode_mem, t::realtype, k::Cint, dky::N_Vector)
    ccall(
        (:ARKStepGetDky, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, realtype, Cint, N_Vector),
        arkode_mem,
        t,
        k,
        dky,
...
function ARKStepGetNumExpSteps(arkode_mem, expsteps)
    ccall(
        (:ARKStepGetNumExpSteps, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        expsteps,
    )
end
...
function ARKStepGetNumAccSteps(arkode_mem, accsteps)
    ccall(
        (:ARKStepGetNumAccSteps, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        accsteps,
...
function ARKStepGetNumStepAttempts(arkode_mem, step_attempts)
    ccall(
        (:ARKStepGetNumStepAttempts, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        step_attempts,
...
function ARKStepGetNumRhsEvals(arkode_mem, nfe_evals, nfi_evals)
    ccall(
        (:ARKStepGetNumRhsEvals, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}, Ptr{Clong}),
        arkode_mem,
        nfe_evals,
        nfi_evals,
    )
...
function ARKStepGetNumLinSolvSetups(arkode_mem, nlinsetups)
    ccall(
        (:ARKStepGetNumLinSolvSetups, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nlinsetups,
...
function ARKStepGetNumErrTestFails(arkode_mem, netfails)
    ccall(
        (:ARKStepGetNumErrTestFails, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        netfails,
...
function ARKStepGetCurrentButcherTables(arkode_mem, Bi, Be)
    ccall(
        (:ARKStepGetCurrentButcherTables, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{ARKodeButcherTable}, Ptr{ARKodeButcherTable}),
        arkode_mem,
        Bi,
        Be,
    )
...
function ARKStepGetEstLocalErrors(arkode_mem, ele::N_Vector)
    ccall(
        (:ARKStepGetEstLocalErrors, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, N_Vector),
        arkode_mem,
        ele,
...
function ARKStepGetWorkSpace(arkode_mem, lenrw, leniw)
    ccall(
        (:ARKStepGetWorkSpace, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}, Ptr{Clong}),
        arkode_mem,
        lenrw,
...
function ARKStepGetNumSteps(arkode_mem, nsteps)
    ccall(
        (:ARKStepGetNumSteps, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nsteps,
...
function ARKStepGetActualInitStep(arkode_mem, hinused)
    ccall(
        (:ARKStepGetActualInitStep, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        hinused,
    )
end
...
function ARKStepGetLastStep(arkode_mem, hlast)
    ccall(
        (:ARKStepGetLastStep, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        hlast,
...
function ARKStepGetCurrentStep(arkode_mem, hcur)
    ccall(
        (:ARKStepGetCurrentStep, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        hcur,
...
function ARKStepGetCurrentTime(arkode_mem, tcur)
    ccall(
        (:ARKStepGetCurrentTime, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        tcur,
...
function ARKStepGetCurrentState(arkode_mem, ycur)
    ccall(
        (:ARKStepGetCurrentState, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{N_Vector}),
        arkode_mem,
        ycur,
    )
end
...
function ARKStepGetCurrentGamma(arkode_mem, gamma)
    ccall(
        (:ARKStepGetCurrentGamma, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        gamma,
...
function ARKStepGetTolScaleFactor(arkode_mem, tolsfac)
    ccall(
        (:ARKStepGetTolScaleFactor, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        tolsfac,
...
function ARKStepGetErrWeights(arkode_mem, eweight::N_Vector)
    ccall(
        (:ARKStepGetErrWeights, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, N_Vector),
        arkode_mem,
        eweight,
...
function ARKStepGetResWeights(arkode_mem, rweight::N_Vector)
    ccall(
        (:ARKStepGetResWeights, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, N_Vector),
        arkode_mem,
        rweight,
...
function ARKStepGetNumGEvals(arkode_mem, ngevals)
    ccall(
        (:ARKStepGetNumGEvals, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        ngevals,
...
function ARKStepGetRootInfo(arkode_mem, rootsfound)
    ccall(
        (:ARKStepGetRootInfo, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Cint}),
        arkode_mem,
        rootsfound,
...
function ARKStepGetNumConstrFails(arkode_mem, nconstrfails)
    ccall(
        (:ARKStepGetNumConstrFails, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nconstrfails,
...
function ARKStepWriteParameters(arkode_mem, fp)
    ccall(
        (:ARKStepWriteParameters, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{FILE}),
        arkode_mem,
        fp,
...
function ARKStepWriteButcher(arkode_mem, fp)
    ccall(
        (:ARKStepWriteButcher, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{FILE}),
        arkode_mem,
        fp,
...
function ARKStepGetTimestepperStats(
    ...
    ccall(
        (:ARKStepGetTimestepperStats, libsundials_arkode),
        Cint,
        (
            ARKStepMemPtr,
            Ptr{Clong},
...
function ARKStepGetStepStats(arkode_mem, nsteps, hinused, hlast, hcur, tcur)
    ccall(
        (:ARKStepGetStepStats, libsundials_arkode),
        Cint,
        (
            ARKStepMemPtr,
            Ptr{Clong},
...
function ARKStepGetNumNonlinSolvIters(arkode_mem, nniters)
    ccall(
        (:ARKStepGetNumNonlinSolvIters, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nniters,
...
function ARKStepGetNumNonlinSolvConvFails(arkode_mem, nncfails)
    ccall(
        (:ARKStepGetNumNonlinSolvConvFails, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nncfails,
...
function ARKStepGetNonlinSolvStats(arkode_mem, nniters, nncfails)
    ccall(
        (:ARKStepGetNonlinSolvStats, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}, Ptr{Clong}),
        arkode_mem,
        nniters,
...
function ARKStepGetLinWorkSpace(arkode_mem, lenrwLS, leniwLS)
    ccall(
        (:ARKStepGetLinWorkSpace, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}, Ptr{Clong}),
        arkode_mem,
        lenrwLS,
...
function ARKStepGetNumJacEvals(arkode_mem, njevals)
    ccall(
        (:ARKStepGetNumJacEvals, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        njevals,
...
function ARKStepGetNumPrecEvals(arkode_mem, npevals)
    ccall(
        (:ARKStepGetNumPrecEvals, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        npevals,
...
function ARKStepGetNumPrecSolves(arkode_mem, npsolves)
    ccall(
        (:ARKStepGetNumPrecSolves, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        npsolves,
...
function ARKStepGetNumLinIters(arkode_mem, nliters)
    ccall(
        (:ARKStepGetNumLinIters, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nliters,
...
function ARKStepGetNumLinConvFails(arkode_mem, nlcfails)
    ccall(
        (:ARKStepGetNumLinConvFails, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nlcfails,
...
function ARKStepGetNumJTSetupEvals(arkode_mem, njtsetups)
    ccall(
        (:ARKStepGetNumJTSetupEvals, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        njtsetups,
...
function ARKStepGetNumJtimesEvals(arkode_mem, njvevals)
    ccall(
        (:ARKStepGetNumJtimesEvals, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        njvevals,
...
function ARKStepGetNumLinRhsEvals(arkode_mem, nfevalsLS)
    ccall(
        (:ARKStepGetNumLinRhsEvals, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nfevalsLS,
...
function ARKStepGetLastLinFlag(arkode_mem, flag)
    ccall(
        (:ARKStepGetLastLinFlag, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        flag,
...
function ARKStepGetMassWorkSpace(arkode_mem, lenrwMLS, leniwMLS)
    ccall(
        (:ARKStepGetMassWorkSpace, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}, Ptr{Clong}),
        arkode_mem,
        lenrwMLS,
...
function ARKStepGetNumMassSetups(arkode_mem, nmsetups)
    ccall(
        (:ARKStepGetNumMassSetups, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nmsetups,
...
function ARKStepGetNumMassMultSetups(arkode_mem, nmvsetups)
    ccall(
        (:ARKStepGetNumMassMultSetups, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nmvsetups,
...
function ARKStepGetNumMassMult(arkode_mem, nmvevals)
    ccall(
        (:ARKStepGetNumMassMult, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nmvevals,
...
function ARKStepGetNumMassSolves(arkode_mem, nmsolves)
    ccall(
        (:ARKStepGetNumMassSolves, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nmsolves,
...
function ARKStepGetNumMassPrecEvals(arkode_mem, nmpevals)
    ccall(
        (:ARKStepGetNumMassPrecEvals, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nmpevals,
...
function ARKStepGetNumMassPrecSolves(arkode_mem, nmpsolves)
    ccall(
        (:ARKStepGetNumMassPrecSolves, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nmpsolves,
...
function ARKStepGetNumMassIters(arkode_mem, nmiters)
    ccall(
        (:ARKStepGetNumMassIters, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nmiters,
...
function ARKStepGetNumMassConvFails(arkode_mem, nmcfails)
    ccall(
        (:ARKStepGetNumMassConvFails, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nmcfails,
...
function ARKStepGetNumMTSetups(arkode_mem, nmtsetups)
    ccall(
        (:ARKStepGetNumMTSetups, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nmtsetups,
...
function ARKStepGetLastMassFlag(arkode_mem, flag)
    ccall(
        (:ARKStepGetLastMassFlag, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        flag,
...
function ARKStepPrintMem(arkode_mem, outfile)
    ccall(
        (:ARKStepPrintMem, libsundials_arkode),
        Cvoid,
        (ARKStepMemPtr, Ptr{FILE}),
        arkode_mem,
        outfile,
...
function ARKBandPrecInit(arkode_mem, N::sunindextype, mu::sunindextype, ml::sunindextype)
    ccall(
        (:ARKBandPrecInit, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, sunindextype, sunindextype, sunindextype),
        arkode_mem,
        N,
        mu,
        ml,
...
function ARKBandPrecGetWorkSpace(arkode_mem, lenrwLS, leniwLS)
    ccall(
        (:ARKBandPrecGetWorkSpace, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}, Ptr{Clong}),
        arkode_mem,
        lenrwLS,
...
function ARKBandPrecGetNumRhsEvals(arkode_mem, nfevalsBP)
    ccall(
        (:ARKBandPrecGetNumRhsEvals, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nfevalsBP,
...
function ARKBBDPrecInit(
    ...
    ccall(
        (:ARKBBDPrecInit, libsundials_arkode),
        Cint,
        (
            ARKStepMemPtr,
            sunindextype,
...
function ARKBBDPrecReInit(
    ...
    ccall(
        (:ARKBBDPrecReInit, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, sunindextype, sunindextype, realtype),
        arkode_mem,
        mudq,
        mldq,
        dqrely,
...
function ARKBBDPrecGetWorkSpace(arkode_mem, lenrwBBDP, leniwBBDP)
    ccall(
        (:ARKBBDPrecGetWorkSpace, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}, Ptr{Clong}),
        arkode_mem,
        lenrwBBDP,
...
function ARKBBDPrecGetNumGfnEvals(arkode_mem, ngevalsBBDP)
    ccall(
        (:ARKBBDPrecGetNumGfnEvals, libsundials_arkode),
        Cint,
        (ARKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        ngevalsBBDP,
...
function ARKodeButcherTable_Alloc(stages, embedded)
    ccall(
        (:ARKodeButcherTable_Alloc, libsundials_arkode),
        ARKodeButcherTable,
        (Cint, Cint),
        stages,
        embedded,
...
function ARKodeButcherTable_Create(s, q::Cint, p::Cint, c::Cint, A, b, d)
    ccall(
        (:ARKodeButcherTable_Create, libsundials_arkode),
        ARKodeButcherTable,
        (Cint, Cint, Cint, Ptr{realtype}, Ptr{realtype}, Ptr{realtype}, Ptr{realtype}),
        s,
        q,
        p,
        c,
...
function ARKodeButcherTable_Copy(B)
    ccall(
        (:ARKodeButcherTable_Copy, libsundials_arkode),
        ARKodeButcherTable,
        (ARKodeButcherTable,),
        B,
    )
...
function ARKodeButcherTable_Space(B, liw, lrw)
    ccall(
        (:ARKodeButcherTable_Space, libsundials_arkode),
        Cvoid,
        (ARKodeButcherTable, Ptr{sunindextype}, Ptr{sunindextype}),
        B,
        liw,
        lrw,
    )
...
function ARKodeButcherTable_Write(B, outfile)
    ccall(
        (:ARKodeButcherTable_Write, libsundials_arkode),
        Cvoid,
        (ARKodeButcherTable, Ptr{Cint}),
        B,
        outfile,
    )
end
...
function ARKodeButcherTable_CheckOrder(B, q, p, outfile)
    ccall(
        (:ARKodeButcherTable_CheckOrder, libsundials_arkode),
        Cint,
        (ARKodeButcherTable, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}),
        B,
        q,
        p,
        outfile,
...
function ARKodeButcherTable_CheckARKOrder(B1, B2, q, p, outfile)
    ccall(
        (:ARKodeButcherTable_CheckARKOrder, libsundials_arkode),
        Cint,
        (ARKodeButcherTable, ARKodeButcherTable, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}),
        B1,
        B2,
        q,
        p,
...
function ARKodeButcherTable_LoadDIRK(imethod::Cint)
    ccall(
        (:ARKodeButcherTable_LoadDIRK, libsundials_arkode),
        ARKodeButcherTable,
        (Cint,),
        imethod,
    )
...
function ARKodeButcherTable_LoadERK(imethod::Cint)
    ccall(
        (:ARKodeButcherTable_LoadERK, libsundials_arkode),
        ARKodeButcherTable,
        (Cint,),
        imethod,
    )
...
function ERKStepCreate(f::ARKRhsFn, t0::realtype, y0::N_Vector)
    ccall(
        (:ERKStepCreate, libsundials_arkode),
        ERKStepMemPtr,
        (ARKRhsFn, realtype, N_Vector),
        f,
        t0,
        y0,
    )
...
function ERKStepResize(
    ...
    ccall(
        (:ERKStepResize, libsundials_arkode),
        Cint,
...
function ERKStepReInit(arkode_mem, f::ARKRhsFn, t0::realtype, y0::N_Vector)
    ccall(
        (:ERKStepReInit, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, ARKRhsFn, realtype, N_Vector),
        arkode_mem,
        f,
        t0,
        y0,
...
function ERKStepSStolerances(arkode_mem, reltol::realtype, abstol::realtype)
    ccall(
        (:ERKStepSStolerances, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype, realtype),
        arkode_mem,
        reltol,
        abstol,
    )
...
function ERKStepSVtolerances(arkode_mem, reltol::realtype, abstol::N_Vector)
    ccall(
        (:ERKStepSVtolerances, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype, N_Vector),
        arkode_mem,
        reltol,
        abstol,
    )
...
function ERKStepWFtolerances(arkode_mem, efun::ARKEwtFn)
    ccall(
        (:ERKStepWFtolerances, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, ARKEwtFn),
        arkode_mem,
        efun,
    )
end
...
function ERKStepRootInit(arkode_mem, nrtfn::Cint, g::ARKRootFn)
    ccall(
        (:ERKStepRootInit, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint, ARKRootFn),
        arkode_mem,
        nrtfn,
        g,
    )
...
function ERKStepSetOrder(arkode_mem, maxord::Cint)
    ccall(
        (:ERKStepSetOrder, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint),
        arkode_mem,
        maxord,
...
function ERKStepSetInterpolantType(arkode_mem, itype::Cint)
    ccall(
        (:ERKStepSetInterpolantType, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint),
        arkode_mem,
        itype,
...
function ERKStepSetInterpolantDegree(arkode_mem, degree::Cint)
    ccall(
        (:ERKStepSetInterpolantDegree, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint),
        arkode_mem,
        degree,
...
function ERKStepSetDenseOrder(arkode_mem, dord::Cint)
    ccall(
        (:ERKStepSetDenseOrder, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint),
        arkode_mem,
        dord,
...
function ERKStepSetTable(arkode_mem, B)
    ccall(
        (:ERKStepSetTable, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, ARKodeButcherTable),
        arkode_mem,
        B,
    )
end
...
function ERKStepSetTableNum(arkode_mem, itable::Cint)
    ccall(
        (:ERKStepSetTableNum, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint),
        arkode_mem,
        itable,
...
function ERKStepSetCFLFraction(arkode_mem, cfl_frac::realtype)
    ccall(
        (:ERKStepSetCFLFraction, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        cfl_frac,
    )
end
...
function ERKStepSetSafetyFactor(arkode_mem, safety::realtype)
    ccall(
        (:ERKStepSetSafetyFactor, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        safety,
...
function ERKStepSetErrorBias(arkode_mem, bias::realtype)
    ccall(
        (:ERKStepSetErrorBias, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        bias,
...
function ERKStepSetMaxGrowth(arkode_mem, mx_growth::realtype)
    ccall(
        (:ERKStepSetMaxGrowth, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        mx_growth,
...
function ERKStepSetFixedStepBounds(arkode_mem, lb::realtype, ub::realtype)
    ccall(
        (:ERKStepSetFixedStepBounds, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype, realtype),
        arkode_mem,
        lb,
...
function ERKStepSetAdaptivityMethod(
    ...
    ccall(
        (:ERKStepSetAdaptivityMethod, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint, Cint, Cint, Ptr{realtype}),
        arkode_mem,
        imethod,
        idefault,
        pq,
...
function ERKStepSetAdaptivityFn(arkode_mem, hfun::ARKAdaptFn, h_data)
    ccall(
        (:ERKStepSetAdaptivityFn, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, ARKAdaptFn, Ptr{Cvoid}),
        arkode_mem,
        hfun,
        h_data,
    )
...
function ERKStepSetMaxFirstGrowth(arkode_mem, etamx1::realtype)
    ccall(
        (:ERKStepSetMaxFirstGrowth, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        etamx1,
...
function ERKStepSetMaxEFailGrowth(arkode_mem, etamxf::realtype)
    ccall(
        (:ERKStepSetMaxEFailGrowth, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        etamxf,
...
function ERKStepSetSmallNumEFails(arkode_mem, small_nef::Cint)
    ccall(
        (:ERKStepSetSmallNumEFails, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint),
        arkode_mem,
        small_nef,
...
function ERKStepSetStabilityFn(arkode_mem, EStab, estab_data)
    ccall(
        (:ERKStepSetStabilityFn, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, ARKExpStabFn, Ptr{Cvoid}),
        arkode_mem,
        EStab,
        estab_data,
    )
...
function ERKStepSetMaxErrTestFails(arkode_mem, maxnef::Cint)
    ccall(
        (:ERKStepSetMaxErrTestFails, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint),
        arkode_mem,
        maxnef,
...
function ERKStepSetConstraints(arkode_mem, constraints::N_Vector)
    ccall(
        (:ERKStepSetConstraints, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, N_Vector),
        arkode_mem,
        constraints,
    )
end
...
function ERKStepSetMaxNumSteps(arkode_mem, mxsteps::Clong)
    ccall(
        (:ERKStepSetMaxNumSteps, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Clong),
        arkode_mem,
        mxsteps,
...
function ERKStepSetMaxHnilWarns(arkode_mem, mxhnil::Cint)
    ccall(
        (:ERKStepSetMaxHnilWarns, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint),
        arkode_mem,
        mxhnil,
...
function ERKStepSetInitStep(arkode_mem, hin::realtype)
    ccall(
        (:ERKStepSetInitStep, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        hin,
...
function ERKStepSetMinStep(arkode_mem, hmin::realtype)
    ccall(
        (:ERKStepSetMinStep, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        hmin,
...
function ERKStepSetMaxStep(arkode_mem, hmax::realtype)
    ccall(
        (:ERKStepSetMaxStep, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        hmax,
...
function ERKStepSetStopTime(arkode_mem, tstop::realtype)
    ccall(
        (:ERKStepSetStopTime, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        tstop,
...
function ERKStepSetFixedStep(arkode_mem, hfixed::realtype)
    ccall(
        (:ERKStepSetFixedStep, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype),
        arkode_mem,
        hfixed,
...
function ERKStepSetMaxNumConstrFails(arkode_mem, maxfails::Cint)
    ccall(
        (:ERKStepSetMaxNumConstrFails, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Cint),
        arkode_mem,
        maxfails,
...
function ERKStepSetRootDirection(arkode_mem, rootdir)
    ccall(
        (:ERKStepSetRootDirection, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{Cint}),
        arkode_mem,
        rootdir,
    )
end
...
function ERKStepSetNoInactiveRootWarn(arkode_mem)
    ccall(
        (:ERKStepSetNoInactiveRootWarn, libsundials_arkode),
        Cint,
        (ERKStepMemPtr,),
        arkode_mem,
    )
...
function ERKStepSetErrHandlerFn(arkode_mem, ehfun::ARKErrHandlerFn, eh_data)
    ccall(
        (:ERKStepSetErrHandlerFn, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, ARKErrHandlerFn, Ptr{Cvoid}),
        arkode_mem,
        ehfun,
        eh_data,
    )
...
function ERKStepSetErrFile(arkode_mem, errfp)
    ccall(
        (:ERKStepSetErrFile, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{FILE}),
        arkode_mem,
        errfp,
    )
end
...
function ERKStepSetUserData(arkode_mem, user_data)
    ccall(
        (:ERKStepSetUserData, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Any),
        arkode_mem,
        user_data,
...
function ERKStepSetDiagnostics(arkode_mem, diagfp)
    ccall(
        (:ERKStepSetDiagnostics, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{FILE}),
        arkode_mem,
        diagfp,
...
#Note, this const was before ARKPostProcessStepFn and now ARKPostProcessFn
function ERKStepSetPostprocessStepFn(arkode_mem, ProcessStep::ARKPostProcessFn)
    ccall(
        (:ERKStepSetPostprocessStepFn, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, ARKPostProcessFn),
        arkode_mem,
        ProcessStep,
    )
end
...
function ERKStepSetPostprocessStageFn(arkode_mem, ProcessStage::ARKPostProcessFn)
    ccall(
        (:ERKStepSetPostprocessStageFn, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, ARKPostProcessFn),
        arkode_mem,
        ProcessStage,
...
function ERKStepEvolve(arkode_mem, tout::realtype, yout::N_Vector, tret, itask::Cint)
    ccall(
        (:ERKStepEvolve, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype, N_Vector, Ptr{realtype}, Cint),
        arkode_mem,
        tout,
        yout,
        tret,
...
function ERKStepGetDky(arkode_mem, t::realtype, k::Cint, dky::N_Vector)
    ccall(
        (:ERKStepGetDky, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, realtype, Cint, N_Vector),
        arkode_mem,
        t,
        k,
        dky,
...
function ERKStepGetNumExpSteps(arkode_mem, expsteps)
    ccall(
        (:ERKStepGetNumExpSteps, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        expsteps,
    )
end
...
function ERKStepGetNumAccSteps(arkode_mem, accsteps)
    ccall(
        (:ERKStepGetNumAccSteps, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        accsteps,
...
function ERKStepGetNumStepAttempts(arkode_mem, step_attempts)
    ccall(
        (:ERKStepGetNumStepAttempts, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        step_attempts,
...
function ERKStepGetNumErrTestFails(arkode_mem, netfails)
    ccall(
        (:ERKStepGetNumErrTestFails, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        netfails,
...
function ERKStepGetCurrentButcherTable(arkode_mem, B)
    ccall(
        (:ERKStepGetCurrentButcherTable, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{ARKodeButcherTable}),
        arkode_mem,
        B,
    )
end
...
function ERKStepGetEstLocalErrors(arkode_mem, ele::N_Vector)
    ccall(
        (:ERKStepGetEstLocalErrors, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, N_Vector),
        arkode_mem,
        ele,
...
function ERKStepGetWorkSpace(arkode_mem, lenrw, leniw)
    ccall(
        (:ERKStepGetWorkSpace, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{Clong}, Ptr{Clong}),
        arkode_mem,
        lenrw,
        leniw,
    )
...
function ERKStepGetNumSteps(arkode_mem, nsteps)
    ccall(
        (:ERKStepGetNumSteps, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nsteps,
...
function ERKStepGetActualInitStep(arkode_mem, hinused)
    ccall(
        (:ERKStepGetActualInitStep, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        hinused,
    )
end
...
function ERKStepGetLastStep(arkode_mem, hlast)
    ccall(
        (:ERKStepGetLastStep, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        hlast,
...
function ERKStepGetCurrentStep(arkode_mem, hcur)
    ccall(
        (:ERKStepGetCurrentStep, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        hcur,
...
function ERKStepGetCurrentTime(arkode_mem, tcur)
    ccall(
        (:ERKStepGetCurrentTime, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        tcur,
...
function ERKStepGetTolScaleFactor(arkode_mem, tolsfac)
    ccall(
        (:ERKStepGetTolScaleFactor, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{realtype}),
        arkode_mem,
        tolsfac,
...
function ERKStepGetErrWeights(arkode_mem, eweight::N_Vector)
    ccall(
        (:ERKStepGetErrWeights, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, N_Vector),
        arkode_mem,
        eweight,
...
function ERKStepGetNumGEvals(arkode_mem, ngevals)
    ccall(
        (:ERKStepGetNumGEvals, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        ngevals,
...
function ERKStepGetRootInfo(arkode_mem, rootsfound)
    ccall(
        (:ERKStepGetRootInfo, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{Cint}),
        arkode_mem,
        rootsfound,
...
function ERKStepGetNumConstrFails(arkode_mem, nconstrfails)
    ccall(
        (:ERKStepGetNumConstrFails, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nconstrfails,
...
function ERKStepWriteParameters(arkode_mem, fp)
    ccall(
        (:ERKStepWriteParameters, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{FILE}),
        arkode_mem,
        fp,
...
function ERKStepWriteButcher(arkode_mem, fp)
    ccall(
        (:ERKStepWriteButcher, libsundials_arkode),
        Cint,
        (ERKStepMemPtr, Ptr{FILE}),
        arkode_mem,
        fp,
...
function ERKStepGetTimestepperStats(
    ...
    ccall(
        (:ERKStepGetTimestepperStats, libsundials_arkode),
        Cint,
...
function ERKStepGetStepStats(arkode_mem, nsteps, hinused, hlast, hcur, tcur)
    ccall(
        (:ERKStepGetStepStats, libsundials_arkode),
        Cint,
        (
            ERKStepMemPtr,
            Ptr{Clong},
...
function ERKStepPrintMem(arkode_mem, outfile)
    ccall(
        (:ERKStepPrintMem, libsundials_arkode),
        Cvoid,
        (ERKStepMemPtr, Ptr{FILE}),
        arkode_mem,
        outfile,
...
function MRIStepCreate(
    ...
    ccall(
        (:MRIStepCreate, libsundials_arkode),
        MRIStepMemPtr,
        (ARKRhsFn, realtype, N_Vector, Sundials.MRISTEP_ID, Ptr{Cvoid}),
        fs,
        t0,
        y0,
        inner_step_id,
...
function MRIStepCreate(fs, t0::realtype, y0, inner_step_mem)
    __y0 = convert(NVector, y0)
    return MRIStepCreate(
        ARKRhsFn_wrapper(fs),
        t0,
        convert(N_Vector, __y0),
        Sundials.MRISTEP_ARKSTEP,
        inner_step_mem,
    )
end
...
function MRIStepResize(arkode_mem, ynew::N_Vector, t0::realtype, resize, resize_data)
    ccall(
        (:MRIStepResize, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, N_Vector, realtype, ARKVecResizeFn, Ptr{Cvoid}),
        arkode_mem,
        ynew,
        t0,
        resize,
...
function MRIStepReInit(arkode_mem, fs::ARKRhsFn, t0::realtype, y0::N_Vector)
    ccall(
        (:MRIStepReInit, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, ARKRhsFn, realtype, N_Vector),
        arkode_mem,
        fs,
        t0,
        y0,
...
function MRIStepRootInit(arkode_mem, nrtfn::Cint, g::ARKRootFn)
    ccall(
        (:MRIStepRootInit, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Cint, ARKRootFn),
        arkode_mem,
        nrtfn,
        g,
    )
...
function MRIStepSetInterpolantType(arkode_mem, itype::Cint)
    ccall(
        (:MRIStepSetInterpolantType, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Cint),
        arkode_mem,
        itype,
...
function MRIStepSetInterpolantDegree(arkode_mem, degree::Cint)
    ccall(
        (:MRIStepSetInterpolantDegree, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Cint),
        arkode_mem,
        degree,
...
function MRIStepSetDenseOrder(arkode_mem, dord::Cint)
    ccall(
        (:MRIStepSetDenseOrder, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Cint),
        arkode_mem,
        dord,
...
function MRIStepSetTable(arkode_mem, q::Cint, B)
    ccall(
        (:MRIStepSetTable, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Cint, ARKodeButcherTable),
        arkode_mem,
        q,
        B,
    )
...
function MRIStepSetTableNum(arkode_mem, itable::Cint)
    ccall(
        (:MRIStepSetTableNum, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Cint),
        arkode_mem,
        itable,
...
function MRIStepSetMaxNumSteps(arkode_mem, mxsteps::Clong)
    ccall(
        (:MRIStepSetMaxNumSteps, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Clong),
        arkode_mem,
        mxsteps,
...
function MRIStepSetMaxHnilWarns(arkode_mem, mxhnil::Cint)
    ccall(
        (:MRIStepSetMaxHnilWarns, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Cint),
        arkode_mem,
        mxhnil,
...
function MRIStepSetStopTime(arkode_mem, tstop)
    ccall(
        (:MRIStepSetStopTime, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, realtype),
        arkode_mem,
        tstop,
    )
end
...
function MRIStepSetFixedStep(arkode_mem, hsfixed::realtype)
    ccall(
        (:MRIStepSetFixedStep, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, realtype),
        arkode_mem,
        hsfixed,
...
function MRIStepSetRootDirection(arkode_mem, rootdir)
    ccall(
        (:MRIStepSetRootDirection, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{Cint}),
        arkode_mem,
        rootdir,
    )
end
...
function MRIStepSetNoInactiveRootWarn(arkode_mem)
    ccall(
        (:MRIStepSetNoInactiveRootWarn, libsundials_arkode),
        Cint,
        (MRIStepMemPtr,),
        arkode_mem,
    )
...
function MRIStepSetErrHandlerFn(arkode_mem, ehfun::ARKErrHandlerFn, eh_data)
    ccall(
        (:MRIStepSetErrHandlerFn, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, ARKErrHandlerFn, Ptr{Cvoid}),
        arkode_mem,
        ehfun,
        eh_data,
    )
...
function MRIStepSetErrFile(arkode_mem, errfp)
    ccall(
        (:MRIStepSetErrFile, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{FILE}),
        arkode_mem,
        errfp,
    )
end
...
function MRIStepSetUserData(arkode_mem, user_data)
    ccall(
        (:MRIStepSetUserData, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Any),
        arkode_mem,
        user_data,
...
function MRIStepSetDiagnostics(arkode_mem, diagfp)
    ccall(
        (:MRIStepSetDiagnostics, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{FILE}),
        arkode_mem,
        diagfp,
...
#new ARKPostProcessFn type. Before it was ARKPostProcessStepFn
function MRIStepSetPostprocessStepFn(arkode_mem, ProcessStep::ARKPostProcessFn)
    ccall(
        (:MRIStepSetPostprocessStepFn, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, ARKPostProcessFn),
        arkode_mem,
        ProcessStep,
    )
end
...
function MRIStepSetPostprocessStageFn(arkode_mem, ProcessStage::ARKPostProcessFn)
    ccall(
        (:MRIStepSetPostprocessStageFn, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, ARKPostProcessFn),
        arkode_mem,
        ProcessStage,
...
#This one does not have MRIStepPreInnerFn
function MRIStepSetPreInnerFn(arkode_mem, prefn::MRIStepPreInnerFn)
    ccall(
        (:MRIStepSetPreInnerFn, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, MRIStepPreInnerFn),
        arkode_mem,
        prefn,
    )
end

#This one does not have MRIStepPostInnerFn
function MRIStepSetPostInnerFn(arkode_mem, postfn::MRIStepPostInnerFn)
    ccall(
        (:MRIStepSetPostInnerFn, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, MRIStepPostInnerFn),
        arkode_mem,
        postfn,
    )
end
...
function MRIStepEvolve(arkode_mem, tout::realtype, yout::N_Vector, tret, itask::Cint)
    ccall(
        (:MRIStepEvolve, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, realtype, N_Vector, Ptr{realtype}, Cint),
        arkode_mem,
        tout,
        yout,
        tret,
...
function MRIStepGetDky(arkode_mem, t::realtype, k::Cint, dky::N_Vector)
    ccall(
        (:MRIStepGetDky, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, realtype, Cint, N_Vector),
        arkode_mem,
        t,
        k,
        dky,
...
function MRIStepGetNumRhsEvals(arkode_mem, nfs_evals)
    ccall(
        (:MRIStepGetNumRhsEvals, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nfs_evals,
    )
end
...
function MRIStepGetCurrentButcherTables(arkode_mem, B)
    ccall(
        (:MRIStepGetCurrentButcherTables, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{ARKodeButcherTable}),
        arkode_mem,
        B,
    )
end
...
function MRIStepGetWorkSpace(arkode_mem, lenrw, leniw)
    ccall(
        (:MRIStepGetWorkSpace, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{Clong}, Ptr{Clong}),
        arkode_mem,
        lenrw,
        leniw,
    )
...
function MRIStepGetNumSteps(arkode_mem, nssteps)
    ccall(
        (:MRIStepGetNumSteps, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{Clong}),
        arkode_mem,
        nssteps,
...
function MRIStepGetLastStep(arkode_mem, hlast)
    ccall(
        (:MRIStepGetLastStep, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{realtype}),
        arkode_mem,
        hlast,
    )
end
...
function MRIStepGetCurrentTime(arkode_mem, tcur)
    ccall(
        (:MRIStepGetCurrentTime, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{realtype}),
        arkode_mem,
        tcur,
...
function MRIStepGetCurrentState(arkode_mem, ycur)
    ccall(
        (:MRIStepGetCurrentState, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{N_Vector}),
        arkode_mem,
        ycur,
    )
end
...
function MRIStepGetNumGEvals(arkode_mem, ngevals)
    ccall(
        (:MRIStepGetNumGEvals, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{Clong}),
        arkode_mem,
        ngevals,
...
function MRIStepGetRootInfo(arkode_mem, rootsfound)
    ccall(
        (:MRIStepGetRootInfo, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{Cint}),
        arkode_mem,
        rootsfound,
...
function MRIStepGetLastInnerStepFlag(arkode_mem, flag)
    ccall(
        (:MRIStepGetLastInnerStepFlag, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{Cint}),
        arkode_mem,
        flag,
...
function MRIStepWriteParameters(arkode_mem, fp)
    ccall(
        (:MRIStepWriteParameters, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{FILE}),
        arkode_mem,
        fp,
...
function MRIStepWriteButcher(arkode_mem, fp)
    ccall(
        (:MRIStepWriteButcher, libsundials_arkode),
        Cint,
        (MRIStepMemPtr, Ptr{FILE}),
        arkode_mem,
        fp,
...
function MRIStepPrintMem(arkode_mem, outfile)
    ccall(
        (:MRIStepPrintMem, libsundials_arkode),
        Cvoid,
        (MRIStepMemPtr, Ptr{FILE}),
        arkode_mem,
        outfile,
